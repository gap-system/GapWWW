...
for y in Concatenation(years,["noyear"]) do
  ...
  AppendTo( output, "layout: default_with_title\n");
  AppendTo( output, "grand_parent: Documentation\n");
  AppendTo( output, "parent: Bibliography\n");
  AppendTo( output, "nav_exclude: true\n");
  AppendTo( output, "---\n\n");                 
