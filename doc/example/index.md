...
t*l*t^-1*l*t*f*t^-1*f^-1*l^-1*t^-1*f*t*f^-1*t^-1*l^-1*t^-1*l*t*l^-1*f\
^-1*l^-1*f*(l*t^-1)^2*f*t^-1*f^-1*l^-3*t^-2*f*l*f*l^-1*f^-1*t^-2*f^-1\
*t*l^-1*f^-1*t^-2*b^-1*e^-1*b*l^-1*e^-1*r*e*f*b*r^-1*b^-1*r^-2*t^-2*l\
^-1*b^-1*r^-1*e^-1
gap> Length( last );
106
```
...
f^-1*t*l*f^-1*l^-1*f*l^-1*t^-1*l*t^-2*f*t*(f^-1*l^-1)^2*l^-1*f*l*e^-1\
*t*e*l*t^-1*e^-1*t^-1*e*l*b*f^-1*b^-1
gap> Length( last );
77
```
...
e^-1*r*f^-1*t^-1*r*l*e*b^-1*e^-1*t^-1*b^-1*e^-1*b*l^-1*(f^-1*l)^2*t^-\
1*f*b*f^2*b^-1*t*f^-1*l*f*l*t*l^-1*t^2*l^-1*f^-1*(l*f)^2*t^-1*f^-1*l^\
-1*t^-1*l*t^2*l^-1*t*l*f^-1*l*f*l^-1*t^-1*(t^-1*l^-1)^2*e*l*e^-1*t*l*\
t^-3*l*t*f*t^-1*f^-2*l^-1*f*t*f*t^-1*f^2*l*f*l^-1*t^-1*l^-1*t*l*t*f*r\
*t*r^-1*t^-1*f^-1*t^-1*l^-1*t^-1*e^-1*t*e*l
gap> Length( last );
100
```
